  ...
  return (
    <section className="relative overflow-hidden bg-paper text-ink sm:min-h-[100svh]">
      ...
      <div className="relative mx-auto flex max-w-6xl flex-col justify-start px-4 pb-10 pt-[calc(4.75rem+env(safe-area-inset-top,0px))] sm:min-h-[100svh] sm:justify-end sm:px-6 sm:pb-20 sm:pt-28 lg:justify-center lg:pb-24 lg:pt-32">
        <div className="w-fit">
          <p className="font-display animate-rise text-[clamp(2.5rem,12vw,5.5rem)] font-extrabold leading-none tracking-tight text-white sm:text-7xl lg:text-8xl">
            Xelity
          </p>
          <div className="animate-draw mt-3 h-1 w-[calc(100%+0.85rem)] bg-signal sm:mt-4 sm:w-[calc(100%+1.25rem)]" />
        </div>

        <h1 className="font-display animate-rise delay-1 mt-5 max-w-[18ch] text-[clamp(1.35rem,5.5vw,2.75rem)] font-bold leading-[1.15] tracking-tight text-white sm:mt-8 sm:max-w-xl">
          Меньше театра. Больше ответа.
        </h1>

        <p className="animate-rise delay-2 mt-3 max-w-[34ch] text-[14px] leading-relaxed text-white/70 sm:mt-5 sm:max-w-md sm:text-base lg:text-lg">
          Xlaude Mini K1, Pro K1 и Mini K2 — для задач, где нужен результат, а не представление.
        </p>
        ...
        <div className="animate-rise delay-3 mt-7 flex w-full flex-col gap-2.5 sm:mt-10 sm:w-auto sm:flex-row sm:gap-3">
          ...
          <Link to="/chat" className="btn-ghost btn-ghost-on-dark w-full justify-center sm:w-auto">
            Попробовать Xlaude
